...
#ifndef THIRD_PARTY_ODML_LITERT_ML_DRIFT_DELEGATE_SHARED_MEMORY_MANAGER_IR_SHARED_MEMORY_MANAGER_CL_LITERT_H_
#define THIRD_PARTY_ODML_LITERT_ML_DRIFT_DELEGATE_SHARED_MEMORY_MANAGER_IR_SHARED_MEMORY_MANAGER_CL_LITERT_H_
...
// Creates a SharedMemoryManager for the OpenCL backend.
std::unique_ptr<SharedMemoryManager> MakeSharedMemoryManagerClLitert(
    ...
    TensorIdToSharedTensorMap& value_to_tensor_map,
...
#endif  // THIRD_PARTY_ODML_LITERT_ML_DRIFT_DELEGATE_SHARED_MEMORY_MANAGER_IR_SHARED_MEMORY_MANAGER_CL_LITERT_H_
