...
#include "ml_drift_delegate/delegate/shared_memory_manager/ir/shared_memory_manager_webgpu_litert.h"
...
MakeSharedMemoryManagerWebgpuLitert(
  ...
  ::ml_drift::ir::SharedMemoryManager::DiscardTensorDataFunc
      discard_tensor_data = [weight_loader, external_buffer_id_map](
                                const ::litert::ml_drift::SharedTfliteTensor&
                                    shared_tflite_tensor) -> absl::Status {
