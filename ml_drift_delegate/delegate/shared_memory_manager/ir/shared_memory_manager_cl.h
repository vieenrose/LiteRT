...
#ifndef THIRD_PARTY_ODML_LITERT_ML_DRIFT_DELEGATE_SHARED_MEMORY_MANAGER_IR_SHARED_MEMORY_MANAGER_CL_H_
#define THIRD_PARTY_ODML_LITERT_ML_DRIFT_DELEGATE_SHARED_MEMORY_MANAGER_IR_SHARED_MEMORY_MANAGER_CL_H_
...
inline std::unique_ptr<SharedMemoryManager> MakeSharedMemoryManagerCl(
    const cl::Environment& env, const CreateGpuModelInfo& create_info,
    ir::IrModel& graph, TfLiteContext* context,
...
#endif  // THIRD_PARTY_ODML_LITERT_ML_DRIFT_DELEGATE_SHARED_MEMORY_MANAGER_IR_SHARED_MEMORY_MANAGER_CL_H_
