...
#include "ml_drift_delegate/delegate/shared_memory_manager/ir/shared_memory_manager_cl_litert.h"
...
std::unique_ptr<::ml_drift::ir::SharedMemoryManager>
MakeSharedMemoryManagerClLitert(
    const ::ml_drift::cl::Environment& env,
    const ::LiteRtRuntimeContext* runtime_context,
    const ::ml_drift::CreateGpuModelInfo& create_info,
    ::ml_drift::ir::IrModel& graph, TfLiteContext* context,
    ::ml_drift::ir::TensorIdToSharedTensorMap& value_to_tensor_map,
  ...
  ::ml_drift::ir::SharedMemoryManager::CreateTensorFromDeviceBufferFunc
  ...
  ::ml_drift::ir::SharedMemoryManager::CreateTensorFunc create_tensor_func =
  ...
  ::ml_drift::ir::SharedMemoryManager::MaybeBindTensorDataFunc maybe_bind_data =
  ...
  ::ml_drift::ir::SharedMemoryManager::PackingLookupFunc packing_lookup =
  ...
  return std::make_unique<::ml_drift::ir::SharedMemoryManager>(
